...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Toolbar tbMainToolBar;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tbMainToolBar;
      Toolbar tbMainToolBar = ViewBindings.findChildViewById(rootView, id);
      if (tbMainToolBar == null) {
        break missingId;
      }

      id = R.id.vPgr2;
      ViewPager2 vPgr2 = ViewBindings.findChildViewById(rootView, id);
      if (vPgr2 == null) {
        break missingId;
      }
